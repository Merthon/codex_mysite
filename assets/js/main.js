(function () {
  ...
  const i18n = {
    zh: {
      ...
      "home.lead": "Leo Merthon，程序员。写 AI、Go 与后端系统，也记录阅读和声音如何塑造判断。",
      "home.ctaNotes": "读取笔记",
      "home.ctaArchive": "翻阅档案",
      "home.player": "PLAYER",
      ...
      "about.structure": "当前包含主页、笔记、档案、关于、留言板和三篇内容页。后续可以继续扩展项目、长文和作品。",
      "guest.title": "本地留言板",
    ...
    en: {
      ...
      "home.lead": "Leo Merthon, programmer. I write about AI, Go, and backend systems, with notes on how reading and sound shape judgment.",
      ...
      "about.structure": "The site now includes home, notes, archive, about, guestbook, and three content pages. Projects and writings can keep growing from here.",
